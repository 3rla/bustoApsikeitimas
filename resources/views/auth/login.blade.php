...
<body class="bg-blue-100 flex items-center justify-center min-h-screen p-4">
    <div class="bg-white p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-sm sm:max-w-md">
        <h2 class="text-xl sm:text-2xl font-bold text-center text-gray-700 mb-4 sm:mb-6">Login</h2>
        ...
        <div class="flex flex-col space-y-2">
            <a href="#"
                class="flex items-center justify-center bg-white border border-gray-300 text-gray-700 py-2 sm:py-3 rounded-md hover:bg-gray-50 transition duration-300 transform hover:scale-105">
                <svg class="h-5 w-5 sm:h-6 sm:w-6 mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <span class="text-sm sm:text-base">Sign up with Google</span>
            </a>
        </div>
    </div>
</body>
