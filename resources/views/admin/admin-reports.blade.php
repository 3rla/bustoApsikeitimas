...
<body>
    ...
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold mb-6">User Reports</h1>

        <!-- Reports List -->
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-2xl font-bold">Existing Reports</h2>
                <div class="flex space-x-2">
                    <input type="text" placeholder="Search reports..." class="border rounded px-2 py-1">
            ...
            <table class="w-full">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="border px-4 py-2">Spam messages</td>
                        <td class="border px-4 py-2">Resolved</td>
